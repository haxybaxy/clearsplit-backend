...
export class AddTransactionCategory1763756979408 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction_component" RENAME COLUMN "category" TO "categoryId"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_component_category_enum" RENAME TO "transaction_component_categoryid_enum"`,
    );
    await queryRunner.query(
      `CREATE TABLE "transaction_category" ("id" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, "custom" boolean NOT NULL DEFAULT true, "teamId" uuid, CONSTRAINT "PK_abbe63b71ee4193f61c322ab497" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD "type" "public"."transaction_type_enum" NOT NULL DEFAULT 'income'`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "categoryId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "categoryId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "finalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "finalCurrencyId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "originalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "originalCurrencyId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "allocation" DROP COLUMN "currencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "allocation" ADD "currencyId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP COLUMN "finalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD "finalCurrencyId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP COLUMN "originalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD "originalCurrencyId" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "team" DROP COLUMN "defaultCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "team" ADD "defaultCurrencyId" character varying NOT NULL DEFAULT 'EUR'`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD CONSTRAINT "FK_1a222a440eaf5c03d63f3bef141" FOREIGN KEY ("categoryId") REFERENCES "transaction_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD CONSTRAINT "FK_af9d692874083ed6dd1173e1c4e" FOREIGN KEY ("finalCurrencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD CONSTRAINT "FK_20f7a7f2a94e0b61518daee26d0" FOREIGN KEY ("originalCurrencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "allocation" ADD CONSTRAINT "FK_10de016337a8f8c8338c530ca45" FOREIGN KEY ("currencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_05fadae0a2c0562efe5200d6bf2" FOREIGN KEY ("finalCurrencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_0011d8e7136d9d30f5df212bcc4" FOREIGN KEY ("originalCurrencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "team" ADD CONSTRAINT "FK_9fbedfd654dae0d57a7dde313df" FOREIGN KEY ("defaultCurrencyId") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_category" ADD CONSTRAINT "FK_transaction_category_teamId_team" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transaction_category" DROP CONSTRAINT "FK_transaction_category_teamId_team"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP CONSTRAINT "FK_1a222a440eaf5c03d63f3bef141"`,
    );
    await queryRunner.query(
      `ALTER TABLE "team" DROP COLUMN "defaultCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "team" ADD "defaultCurrencyId" character varying(3) NOT NULL DEFAULT 'EUR'`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP COLUMN "originalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD "originalCurrencyId" character varying(3) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP COLUMN "finalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD "finalCurrencyId" character varying(3) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "allocation" DROP COLUMN "currencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "allocation" ADD "currencyId" character varying(3)`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "originalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "originalCurrencyId" character varying(3)`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "finalCurrencyId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "finalCurrencyId" character varying(3)`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" DROP COLUMN "categoryId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" ADD "categoryId" "public"."transaction_component_categoryid_enum" NOT NULL DEFAULT 'rent'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."transaction_component_categoryid_enum" RENAME TO "transaction_component_category_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_component" RENAME COLUMN "categoryId" TO "category"`,
    );
    await queryRunner.query(
